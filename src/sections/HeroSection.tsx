...
export default function HeroSection({ onExploreProjects }: HeroSectionProps) {
  ...
  return (
    ...
    >
      {/* LAYER 1: Giant, ultra-tall stacked text "PORTFOLIO" in semi-transparent dark crimson red (#D31A21 ~15% opacity) */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[22vw] font-bold text-[#D31A21]/[0.15] uppercase tracking-tighter pointer-events-none font-heading whitespace-nowrap z-0 leading-none">
        PORTFOLIO
      </div>

      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-[1.3fr_1.1fr_0.6fr] gap-8 items-center relative z-10">
        ...
        <div className="space-y-6 flex flex-col justify-center">
          ...
          <div className="space-y-2">
            ...
            <h1 
              ref={titleRef}
              className="hero-fade text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-none tracking-tight text-white font-heading uppercase"
            >
          ...
          <div className="hero-fade flex items-center gap-2 text-xs font-mono text-[#8E8E93] tracking-widest uppercase">
          ...
          <div className="hero-fade flex flex-wrap gap-4 pt-2">
            <button
              ...
              className="px-6 py-3.5 bg-[#E50914] hover:bg-[#b01e1e] text-white font-bold text-xs flex items-center gap-2 cursor-pointer transition-all duration-300 font-mono uppercase tracking-widest"
            >
            ...
            <a
              ...
              className="px-6 py-3.5 bg-neutral-900 border border-neutral-800 hover:bg-neutral-800 text-white font-bold text-xs flex items-center gap-2 transition-all duration-300 font-mono uppercase tracking-widest"
            >
            ...
            {showHireOptions ? (
              <div className="flex gap-2 items-center bg-neutral-900 border border-neutral-800 p-1.5 animate-fade-in">
                <a
                  ...
                  className="px-4 py-2 bg-[#1dbf73] hover:bg-[#158f55] text-white font-bold text-[10px] flex items-center gap-1 transition-all"
                >
                  <span>Fiverr</span>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-4 py-2 bg-[#37a000] hover:bg-[#287500] text-white font-bold text-[10px] flex items-center gap-1 transition-all"
                >
                  <span>Upwork</span>
                  <ExternalLink className="w-2.5 h-2.5" />
                </a>
              ...
              <button
                ...
                className="px-5 py-3.5 border border-[#E50914]/40 bg-[#E50914]/10 hover:bg-[#E50914]/20 text-[#E50914] font-bold text-xs flex items-center gap-1.5 transition-all cursor-pointer font-mono uppercase tracking-widest"
              >
                <span>Hire Me</span>
        ...
        {/* LAYER 2: Center Portrait Cutout (NO card wrapper, NO borders, bottom gradient mask to #0D0D0D) */}
        ...
        {/* LAYER 4: Right Column Metrics (NO boxes, NO cards, stacked vertically with large red numbers) */}
        <div className="flex flex-col gap-8 w-full justify-center pl-0 lg:pl-6 border-l-0 lg:border-l border-neutral-800/60">
          {statsList.map((stat, i) => (
            <div key={i} className="hero-fade text-left space-y-1">
              <div className="text-5xl sm:text-6xl font-bold font-heading text-[#E50914] leading-none">
                {stat.value}
              </div>
